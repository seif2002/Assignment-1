...
void DefaultSceneLayer::_CreateScene()
{
	...
	if (loadScene && std::filesystem::exists("scene.json")) {
		...
		MeshResource::Sptr FastEnemyMesh = ResourceManager::CreateAsset<MeshResource>("Fast Enemy.obj");
		...
		Texture2D::Sptr    FastEnemyTex = ResourceManager::CreateAsset<Texture2D>("textures/Fast Enemy.png");
		Texture2D::Sptr    HeartTex = ResourceManager::CreateAsset<Texture2D>("textures/Heart.jpg");
...
#pragma endregion 
		...
		Material::Sptr FastEnemyMaterial = ResourceManager::CreateAsset<Material>(deferredForward);
		{
			...
			FastEnemyMaterial->Set("u_Material.AlbedoMap", FastEnemyTex);
		...
		{
			HeartMaterial->Name = "FastEnemyMaterial";
			HeartMaterial->Set("u_Material.AlbedoMap", HeartTex);
		...
		GameObject::Sptr gameobj = scene->CreateGameObject("Cube");
		{
			gameobj->SetPostion(glm::vec3(2.0f, 1.0f, 0.0f));

			gameobj->Add<RotatingBehaviour>();
			gameobj->Get<RotatingBehaviour>()->RotationSpeed = glm::vec3(0.0f, 0.0f, 5.0f);

			RenderComponent::Sptr renderer = gameobj->Add<RenderComponent>();
			renderer->SetMesh(FastEnemyMesh);
			renderer->SetMaterial(FastEnemyMaterial);

		}
	
		GameObject::Sptr obj = scene->CreateGameObject("Cube2");
		{
		    obj->SetPostion(glm::vec3(5.0f, 1.0f, 1.0f));

			obj->Add<RotatingBehaviour>();
			obj->Get<RotatingBehaviour>()->RotationSpeed = glm::vec3(01.0f, 3.0f, 5.0f);
